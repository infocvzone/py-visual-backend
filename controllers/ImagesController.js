const {
  ...
  const Pictur = require("../models/images");
  ...
  exports.createImage = async (req, res) => {
    ...
    const fileKey = `fixedAssets/Images/${req.file.originalname}`;
    ...
    try {
      ...
      const newImage = new Pictur({ url: imageUrl, scale_value });
      await newImage.save();
  ...
  exports.getAllImages = async (req, res) => {
    try {
      const images = await Pictur.find();
  ...
  exports.deleteImage = async (req, res) => {
    try {
      const image = await Pictur.findById(req.params.id);
      ...
      await Pictur.findByIdAndDelete(req.params.id);
